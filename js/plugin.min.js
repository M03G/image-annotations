(function ($) {
	...
	$(function () {
		...
		$('.comment-image').on('click', 'img', function (e) {
			...
			console.log((relativeX / (e.target.width / 100)));
		...
		$('.ia-main').on('click', '.ia-area-vis-switch', function (e) {
			ai_showhide($(this), ".ia-main", ".ia-area", 300);
		});

		$('.ia-main').on('click', '.ia-annotations-vis-switch', function (e) {
			ai_showhide($(this), ".comment-content", ".ia-annotations", 500);
		});

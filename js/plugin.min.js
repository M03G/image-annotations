(function ($) {
	...
	$(function () {
		...
		$('.comment-image').on('click', 'img', function (e) {
			...
			console.log($($(this).closest('.ia-main')).is('.ia-main'));
		...
		$('.ia-main').on('click', '.ia-area-vis-switch', function (e) {
			...
			if (vis == 'on') {
				$($(this).closest(".ia-main")).children(".ia-area").css("display", "none");
				$(this).attr("vis", "off");
				$(this).removeClass("hide");
				$(this).addClass("show");
			} else {
				$($(this).closest(".ia-main")).children(".ia-area").css("display", "block");
				$(this).attr("vis", "on");
		...
		$('.ia-main').on('click', '.ia-annotations-vis-switch', function (e) {
			var vis = $(this).attr("vis");
			if (vis == 'on') {
				$($(this).closest(".comment-content")).children(".ia-annotations").css("display", "none");
				$(this).attr("vis", "off");
				$(this).removeClass("hide");
				$(this).addClass("show");
			} else {
				$($(this).closest(".comment-content")).children(".ia-annotations").css("display", "block");
				$(this).attr("vis", "on");
				$(this).removeClass("show");
				$(this).addClass("hide");
			}
		});
		$('body').on('click', '.ia-cancel', function (e) {
			console.log("Click Cancel!");
			// при нажатии на кнопку Cancel, удаляем поле на картинке
			killanot();
		});
		$('body').on('click', '.ia-ok', function (e) {

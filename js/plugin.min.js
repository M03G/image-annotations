(function ($) {
	...
	$(function () {
		...
		$('body').on('click', '.cancelComm', function (e) {
			...
			$(".anotBox").remove();
			// и скрываем поле ввода комментариев
		...
		$('.coi-one').hover(
			function(){
				var numb = $(this).attr('coi-numb');
				console.log(numb);
				$("#coi-numb-" + numb).animate({
						backgroundColor:'rgba(0,0,0,0.22)'}, 700);
				// var leftcom = $(this).attr('coi-left');
				// var sidecom = $(this).attr('coi-side');
				// console.log(topcom + ' ' + leftcom + ' ' + sidecom);
			},
			function(){
				var numb = $(this).attr('coi-numb');
				$("#coi-numb-" + numb).animate({

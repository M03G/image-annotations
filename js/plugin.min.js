(function ($) {
	...
	$(function () {
		...
		$('.comment-image').on('click', 'img', function (e) {
			...
			var htmlArr = [];
			htmlArr.push('<div class="anotBox" style="width:30px;height:30px;border:1px solid #000000;z-index:10;border-radius:15px;position:absolute;left:' + (e.pageX-15) + 'px;top:' + (e.pageY-15) + 'px;"></div>"');
			// if (!$("div").is(".anotText")){
